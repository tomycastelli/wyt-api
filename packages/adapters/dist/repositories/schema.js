...
import { customType, index, integer, pgEnum, pgTable, primaryKey, text, timestamp, uniqueIndex, varchar, } from "drizzle-orm/pg-core";
...
const blockchainValue = customType({
    dataType() {
        return "numeric(24, 0)";
    },
    fromDriver(value) {
...
export const blockchainsEnum = pgEnum("blockchains_enum", Object.keys(blockchains));
...
export const coins = pgTable("coins", {
    ...
    price_change_percentage_24h: smallDecimalNumber("price_change_percentage_24h").notNull(),
...
export const nfts = pgTable("nfts", {
    ...
    price: decimalNumber("price").notNull(),
    blockchain: blockchainsEnum("blockchain").notNull().$type(),
    contract_address: varchar("contract_address").notNull(),
});
export const wallets = pgTable("wallets", {
    ...
    return {
        uniqueAddressBlockchain: uniqueIndex("unique_address_blockchain").on(table.address, table.blockchain),
    };
});
export const walletCoins = pgTable("wallet_coins", {
