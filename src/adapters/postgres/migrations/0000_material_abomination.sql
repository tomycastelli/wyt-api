DO $$ BEGIN
 CREATE TYPE "public"."blockchains_enum" AS ENUM('ethereum', 'solana', 'avalanche', 'polygon-pos', 'binance-smart-chain');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS "candles" (
	...
	CONSTRAINT "candles_coin_id_interval_timestamp_pk" PRIMARY KEY("coin_id","interval","timestamp")
);
--> statement-breakpoint
